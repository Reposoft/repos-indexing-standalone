...
# Second terminal
awslocal lambda invoke --function-name HelloLambdaFunction --endpoint-url=http://127.0.0.1:3001 --cli-binary-format raw-in-base64-out --payload '[1,4,7]' output.txt
